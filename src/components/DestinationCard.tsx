...
export const DestinationCard: React.FC<DestinationCardProps> = ({ destination }) => {
  return (
    <Link 
      ...
      className="group relative flex flex-col rounded-3xl overflow-hidden bg-brand-card border border-white/10 hover:border-brand-orange/50 transition-all duration-300 hover:-translate-y-1.5 shadow-xl hover:shadow-2xl"
    >
      {/* Image container */}
      <div className="relative aspect-[4/3] w-full overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <span className="px-3 py-1 rounded-full text-[11px] font-semibold bg-slate-950/80 backdrop-blur-md text-white border border-white/15">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <h3 className="text-2xl font-bold font-display text-white group-hover:text-brand-orange transition-colors flex items-center justify-between drop-shadow-md">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4 bg-brand-card">
        ...
        <div className="w-full py-2.5 rounded-xl bg-white/5 group-hover:bg-brand-orange/20 text-center text-xs font-semibold text-slate-200 group-hover:text-brand-orange border border-white/10 transition-colors flex items-center justify-center gap-1.5">
