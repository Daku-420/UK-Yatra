      ...
      <nav className="glass-header py-3 shadow-xl border-b border-white/10 px-4 sm:px-6 lg:px-8 xl:px-10 transition-all duration-300">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-3 xl:gap-6">
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3 shrink-0">
            ...
            <Link
              to="/admin"
              className="px-2.5 xl:px-3.5 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-slate-100 hover:text-white border border-white/20 text-xs font-bold transition-all flex items-center gap-1.5 shadow-sm hover:scale-105 whitespace-nowrap shrink-0"
